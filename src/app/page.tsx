...
export default function LandingPage() {
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        {
          id: "p5",          name: "Bull Run Burger ",          price: "$11.00",          variant: "Single/Double Patty with Pepper Jack Cheese, Bacon, Jalapeño Cream Cheese and Bull Run Sauce.",          imageSrc: "http://img.b2bpic.net/free-photo/hamburger-chopping-board-with-spinach-tomatoes-avocado-wooden-board_23-2148165610.jpg",          imageAlt: "A vegetarian smash burger with fresh toppings"},
        {
