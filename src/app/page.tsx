...
export default function LandingPage() {
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        {
          id: "p5",          name: "Cyrpto Burger ",          price: "",          variant: "Jalapeño Cream Cheese Smash Paddy with Pepper Jack Cheese, Bacon and Bull Run Sauce.",          imageSrc: "https://storage.googleapis.com/webild/users/user_3CJnQJYMSiA6jhejhdDXPX2Rx55/uploaded-1781577165990-yvjplb98.png",          imageAlt: "A vegetarian smash burger with fresh toppings"}
      ]}
