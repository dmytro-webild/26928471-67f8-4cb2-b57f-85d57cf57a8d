...
export default function LandingPage() {
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        {
          id: "p5",          name: "Cyrpto Burger ",          price: "",          variant: "Jalapeño Cream Cheese Smash Patty with Pepper Jack Cheese, Bacon and Bull Run Sauce.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CJnQJYMSiA6jhejhdDXPX2Rx55/uploaded-1780373817934-wil1b604.png",          imageAlt: "A vegetarian smash burger with fresh toppings"}
      ]}
