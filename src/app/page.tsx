...
export default function LandingPage() {
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        {
          id: "p2",          name: "Jersey Boy",          price: "",          variant: "Single/Double Smash Patty with Fried Taylor Ham, White American Cheese and a Fried Egg.",          imageSrc: "https://storage.googleapis.com/webild/users/user_3CJnQJYMSiA6jhejhdDXPX2Rx55/uploaded-1781577336493-gdoaepfr.png",          imageAlt: "A spicy smash burger with jalapeños and melted cheese"},
        {
