...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      showDimOverlay={true}
      imageClassName="object-cover w-full h-[var(--height-100)]"
    />
  </div>
  ...
  <div id="products" data-section="products">
      ...
      products={[
        {
          id: "p1",          name: "Classic Paddy Smash",          price: "",          variant: "Single/Double Smash Patty with Cheese, Pickles and our Famous Paddy Sauce.",          imageSrc: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3CJnQJYMSiA6jhejhdDXPX2Rx55/uploaded-1780452491452-l6ueuhic.png",          imageAlt: "A classic smash burger with cheese, lettuce, and tomato"},
        {
